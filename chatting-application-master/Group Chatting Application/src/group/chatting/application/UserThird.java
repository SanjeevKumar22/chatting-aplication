...
public class UserThird extends JFrame implements ActionListener, Runnable {
    ...
    UserThird() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("group/chatting/application/icons/cse.png"));
        ...
        JLabel l3 = new JLabel("CSE");
        l3.setFont(new Font("SAN_SERIF", Font.BOLD, 18));
        l3.setForeground(Color.WHITE);
        l3.setBounds(110, 15, 100, 18);
        p1.add(l3);

        JLabel l4 = new JLabel("vikas, siddu, syed, shoaib, satish");
